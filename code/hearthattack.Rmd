...
Las preguntas que se pretenden responder son: ¿Quién sufre más de
colesterol hombres o mujeres? ¿Cómo afecta el aumento de los niveles del
colesterol a la frecuencia cardíaca?
...
Comprobamos que el p-valor de la prueba de Levene es de 0.1, por lo que
no se rechaza la hipótesis nula y se considera que las muestras tienen
varianzas similares.
...
-   Entre hombres y mujeres las muestras del colesterol y frecuencia
    cardíaca tienen una varianza similar.

-   Los hombres (sexo 0) tienen el colesterol más alto que las mujeres
    (sexo 1).

-   Entre hombres y mujeres no se aprecia diferencias significativas en
